...
namespace Telbot.api
{
    class Urls
    {
        ...
        public const string BASE_URL = "https://easy-bots.com/api";
        public const string UPDATE_INFO_URL = "https://easy-bots.com/download/updates.txt";
        ...
        public const string APP_LOGOUT = BASE_URL + "/v1/member-app/logout";
    }
}
